...
For template formatting examples, see [`/starter_projects`](https://github.com/minerva-ai/minerva/tree/main/src/backend/base/minerva/initial_setup/starter_projects) in the Langflow repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Langflow repository](https://github.com/minerva-ai/minerva) on GitHub.
...
For more information, see the Langflow repository's [template categories](https://github.com/minerva-ai/minerva/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).