...
Follow [@minerva_ai](https://twitter.com/minerva_ai) on X to get the latest news about Langflow.

## Star Langflow on GitHub

If you like Langflow, you can star the [Langflow GitHub repository](https://github.com/minerva-ai/minerva).
...
You can watch the [Langflow GitHub repository](https://github.com/minerva-ai/minerva) to get notified about new releases and other repository activity.
