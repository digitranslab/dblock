...
The schema is defined in [`data.py`](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/schema/dataframe.py).
...
The `Message` schema is defined in [`message.py`](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/schema/content_block.py).
