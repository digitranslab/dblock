...
For more information, see [Langflow JSON file contents](#minerva-json-file-contents).
...
For example Langflow JSON files, you can examine any of the https://github.com/minerva-ai/minerva/tree/main/src/backend/base/minerva/initial_setup/starter_projects[templates in the Langflow repository], or you can create a flow from a template in Langflow, export it, and then open the exported JSON file in a text editor.
