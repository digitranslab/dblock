...
1. Follow this link to launch the Cloud Shell with the GCP deployment script from the Langflow repository:
   ...
   [![Deploy to Google Cloud](https://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/minerva-ai/minerva&working_dir=scripts/gcp&shellonly=true&tutorial=walkthroughtutorial.md)
