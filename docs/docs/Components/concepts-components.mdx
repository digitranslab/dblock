...
For example, the [**Recursive Character Text Splitter** component](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://github.com/minerva-ai/minerva/blob/main/src/backend/base/minerva/base/textsplitters/model.py) class.
