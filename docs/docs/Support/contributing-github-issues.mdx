...
The [Issues page in the Langflow repository](https://github.com/minerva-ai/minerva/issues) is actively updated with bugs and feature requests.
...
Use the [Langflow repository's labels](https://github.com/minerva-ai/minerva/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Langflow in general, you can visit the [Langflow GitHub Discussions page](https://github.com/minerva-ai/minerva/discussions) or reach out through other [Langflow community](/contributing-community) channels.
