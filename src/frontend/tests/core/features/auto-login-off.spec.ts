...
test(
  ...
  async ({ page }) => {
    ...
    await page.waitForSelector("text=sign in to minerva", { timeout: 30000 });

    await page.getByPlaceholder("Username").fill("minerva");
    await page.getByPlaceholder("Password").fill("minerva");
