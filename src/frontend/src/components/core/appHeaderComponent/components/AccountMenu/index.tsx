...
import { ENABLE_DATASTAX_FLOWAI } from "@/customization/feature-flags";
    ...
    <>
      <HeaderMenu>
        <HeaderMenuToggle>
          ...
          >
            {ENABLE_DATASTAX_FLOWAI ? <CustomProfileIcon /> : <ProfileIcon />}
          </div>
        </HeaderMenuToggle>
        <HeaderMenuItems position="right">
          {ENABLE_DATASTAX_FLOWAI && (
            <HeaderMenuItemsSection>
          ...
          <HeaderMenuItemsSection>
            <div className="flex h-[46px] w-full items-center justify-between px-3">
              ...
              {!ENABLE_DATASTAX_FLOWAI && <ThemeButtons />}
            </div>
            {ENABLE_DATASTAX_FLOWAI ? (
            ...
            {ENABLE_DATASTAX_FLOWAI ? (
              ...
              <HeaderMenuItemLink newPage href="https://docs.flowai.cloud">
          ...
          <HeaderMenuItemsSection>
            {ENABLE_DATASTAX_FLOWAI ? (
              <HeaderMenuItemLink
                newPage
                href="https://github.com/digitranslab/flowai"
              >
              ...
              <HeaderMenuItemLink
                newPage
                href="https://github.com/digitranslab/flowai/discussions"
              >
            ...
            <HeaderMenuItemLink newPage href="https://twitter.com/flowai_ai">
