        ...
        {!ENABLE_DATASTAX_MINERVA && (
          <>
            <Button
              ...
              onClick={() =>
                window.open("https://github.com/digitranslab/minerva", "_blank")
              }
            >
              <GithubStarComponent />
            </Button>
          ...
          <>
            <ShadTooltip content="Docs" side="bottom" styleClasses="z-10">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://docs.datastax.com/en/minerva/index.html",
                    "_blank",
                  )
                }
              >
