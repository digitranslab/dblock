          ...
          <Card className="p-8">
            ...
            <CardContent className="grid">
              <div>
                <p>
                  ...
                  <a
                    href="https://github.com/digitranslab/minerva/issues"
                    target="_blank"
            ...
            <CardFooter>
              <div className="m-auto mt-4 flex justify-center">
                <Button onClick={resetErrorBoundary}>Restart Minerva</Button>

                <a
                  href="https://github.com/digitranslab/minerva/issues/new"
                  target="_blank"
                  rel="noopener noreferrer"
                >
