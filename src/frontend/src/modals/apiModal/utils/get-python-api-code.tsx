...
import warnings
try:
    from flowai.load import upload_file
except ImportError:
    warnings.warn("Flowai provides a function to help you upload files to the flow. Please install flowai to use it.")
    upload_file = None
...
def main():
    ...
    if args.upload_file:
        if not upload_file:
            raise ImportError("Flowai is not installed. Please install it to use the upload_file function.")
