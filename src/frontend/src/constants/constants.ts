...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Flowai documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Flowai: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Flowai API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const FLOWAI_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const FLOWAI_CHAT_TITLE = "Flowai Chat";
...
export const STORE_TITLE = "Flowai Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Flowai API key.";
...
export const FLOWAI_ACCESS_TOKEN = "access_token_lf";
export const FLOWAI_API_TOKEN = "apikey_tkn_lflw";
export const FLOWAI_AUTO_LOGIN_OPTION = "auto_login_lf";
export const FLOWAI_REFRESH_TOKEN = "refresh_token_lf";

export const FLOWAI_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const FLOWAI_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
