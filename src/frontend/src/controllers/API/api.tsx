import { MINERVA_ACCESS_TOKEN } from "@/constants/constants";
  ...
  useEffect(() => {
    const unregister = fetchIntercept.register({
      request: function (url, config) {
        const accessToken = cookies.get(MINERVA_ACCESS_TOKEN);
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/digitranslab/minerva_examples/main/examples",
        "https://api.github.com/repos/digitranslab/minerva_examples/contents/examples",
        "https://api.github.com/repos/digitranslab/minerva",
        "auto_login",
      ];
