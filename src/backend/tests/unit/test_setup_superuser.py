...
from minerva.services.settings.constants import (
    DEFAULT_SUPERUSER,
    DEFAULT_SUPERUSER_PASSWORD,
)
from minerva.services.utils import teardown_superuser

# @patch("minerva.services.deps.get_session")
# @patch("minerva.services.utils.create_super_user")
# @patch("minerva.services.deps.get_settings_service")
# # @patch("minerva.services.utils.verify_password")
