...
from minerva.api.utils import get_suggestion_message
from minerva.services.database.models.flow.utils import get_outdated_components
from minerva.utils.version import get_version_info
...
def test_get_outdated_components():
    ...
    with patch(
        "minerva.services.database.models.flow.utils.get_components_versions", return_value=mock_component_versions
    ):
