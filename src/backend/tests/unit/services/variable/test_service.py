...
import pytest
from flowai.services.database.models.variable.model import VariableUpdate
...
from flowai.services.variable.constants import CREDENTIAL_TYPE
from flowai.services.variable.service import DatabaseVariableService
...
async def test_initialize_user_variables__not_found_variable(service, session: AsyncSession):
    with patch("flowai.services.variable.service.DatabaseVariableService.create_variable") as m:
