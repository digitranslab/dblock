...
from flowai.custom.directory_reader.utils import abuild_custom_component_list_from_path
from flowai.initial_setup.constants import STARTER_FOLDER_NAME
from flowai.initial_setup.setup import (
    detect_github_url,
    get_project_data,
...
from flowai.interface.components import aget_all_types_dict
from flowai.services.database.models import Flow
from flowai.services.database.models.folder.model import Folder
from flowai.services.deps import get_settings_service, session_scope
...
async def test_refresh_starter_projects():
    data_path = str(await anyio.Path(__file__).parent.parent.parent.absolute() / "base" / "flowai" / "components")
...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://github.com/digitranslab/flowai-bundles",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/main.zip",
        ...
        (
            "https://github.com/digitranslab/flowai-bundles.git",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/tree/some.branch-0_1",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/some.branch-0_1.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/tree/some/branch",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/some/branch.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/tree/some/branch/",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/heads/some/branch.zip",
        ...
        (
            "https://github.com/digitranslab/flowai-bundles/releases/tag/v1.0.0-0_1",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/tags/v1.0.0-0_1.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/releases/tag/foo/v1.0.0",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/releases/tag/foo/v1.0.0/",
            "https://github.com/digitranslab/flowai-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ...
        (
            "https://github.com/digitranslab/flowai-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9",
            "https://github.com/digitranslab/flowai-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
        ),
        (
            "https://github.com/digitranslab/flowai-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/",
            "https://github.com/digitranslab/flowai-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
...
async def test_load_bundles_from_urls():
    ...
    try:
        ...
        assert "flowai-bundles-68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/components" in components_paths[0]
