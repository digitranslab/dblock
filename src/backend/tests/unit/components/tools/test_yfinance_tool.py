...
from minerva.components.tools import YfinanceComponent
from minerva.components.tools.yahoo import YahooFinanceMethod
...
class TestYfinanceComponent:
    ...
    @patch("minerva.components.tools.yahoo.yf.Ticker")
