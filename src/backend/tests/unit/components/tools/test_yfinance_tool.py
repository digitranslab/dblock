...
from flowai.components.tools import YfinanceComponent
from flowai.components.tools.yahoo import YahooFinanceMethod
...
class TestYfinanceComponent:
    ...
    @patch("flowai.components.tools.yahoo.yf.Ticker")
