...
import pytest
from minerva.components.helpers.structured_output import StructuredOutputComponent
from minerva.helpers.base_model import build_model_from_schema
from minerva.inputs.inputs import TableInput
...
class TestStructuredOutputComponent:
    def test_successful_structured_output_generation_with_patch_with_config(self):
        ...
        with patch("minerva.components.helpers.structured_output.get_chat_result", mock_get_chat_result):
    ...
    @patch("minerva.components.helpers.structured_output.get_chat_result")
