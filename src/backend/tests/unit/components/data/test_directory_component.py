...
import pytest
from flowai.components.data import DirectoryComponent
...
class TestDirectoryComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("flowai.components.data.directory.parallel_load_data")
    @patch("flowai.components.data.directory.retrieve_file_paths")
    @patch("flowai.components.data.DirectoryComponent.resolve_path")
