...
from flowai.services.database.models.flow.model import Flow, FlowCreate
from flowai.services.database.models.folder.model import Folder
from flowai.services.database.models.transactions.model import TransactionTable
from flowai.services.database.models.user.model import User, UserCreate, UserRead
from flowai.services.database.models.vertex_builds.crud import delete_vertex_builds_by_flow_id
    ...
    if "benchmark" in request.keywords:
        ...
        with blockbuster_ctx() as bb:
            ...
            (
                ...
                .can_block_in("flowai/custom/custom_component/component.py", "set_class_code")
...
def _setup_env(monkeypatch):
    monkeypatch.setenv("FLOWAI_CACHE_TYPE", "redis")
    monkeypatch.setenv("FLOWAI_REDIS_HOST", "result_backend")
    monkeypatch.setenv("FLOWAI_REDIS_PORT", "6379")
    monkeypatch.setenv("FLOWAI_REDIS_DB", "0")
    monkeypatch.setenv("FLOWAI_REDIS_EXPIRE", "3600")
    monkeypatch.setenv("FLOWAI_REDIS_PASSWORD", "")
...
def distributed_client_fixture(
    ...
    from flowai.core import celery_app
    ...
    try:
        ...
        # monkeypatch flowai.services.task.manager.USE_CELERY to True
        # monkeypatch.setattr(manager, "USE_CELERY", True)
        monkeypatch.setattr(celery_app, "celery_app", celery_app.make_celery("flowai", Config))
...
def deactivate_tracing(monkeypatch):
    monkeypatch.setenv("FLOWAI_DEACTIVATE_TRACING", "true")
    yield
    monkeypatch.undo()
    ...
    if "noclient" in request.keywords:
        ...
        def init_app():
            ...
            if "load_flows" in request.keywords:
                ...
                monkeypatch.setenv("FLOWAI_LOAD_FLOWS_PATH", load_flows_dir)
                monkeypatch.setenv("FLOWAI_AUTO_LOGIN", "true")
