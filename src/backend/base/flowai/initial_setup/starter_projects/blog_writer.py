...
from flowai.components.data import URLComponent
...
""")
    ...
    url_component.set(urls=["https://flowai.cloud/", "https://docs.flowai.cloud/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Flowai and AI. "
