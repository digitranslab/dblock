...
from flowai.api.utils import DbSession
from flowai.services.database.models.flow import Flow
from flowai.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the flowai instance is up
# therefore it's not a reliable health check for a flowai instance
...
# It's a reliable health check for a flowai instance
