...
from flowai.events.event_manager import EventManager, create_default_event_manager
from flowai.exceptions.component import ComponentBuildError
from flowai.graph.graph.base import Graph
from flowai.graph.utils import log_vertex_build
from flowai.schema.message import ErrorMessage
...
from flowai.services.deps import get_chat_service, get_session, get_telemetry_service, session_scope
from flowai.services.telemetry.schema import ComponentPayload, PlaygroundPayload

if TYPE_CHECKING:
    from flowai.graph.vertex.vertex_types import InterfaceVertex
...
async def try_running_celery_task(vertex, user_id):
    ...
    try:
        from flowai.worker import build_vertex
