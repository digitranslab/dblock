...
from flowai.api.utils import CurrentActiveUser, check_flowai_version
from flowai.services.auth import utils as auth_utils
from flowai.services.deps import get_settings_service, get_store_service
from flowai.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_flowai_version(component)
