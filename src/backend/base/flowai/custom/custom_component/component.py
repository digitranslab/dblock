...
from flowai.base.tools.constants import (
...
from flowai.custom.tree_visitor import RequiredInputsVisitor
from flowai.exceptions.component import StreamingError
from flowai.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output
from flowai.graph.state.model import create_state_model
from flowai.graph.utils import has_chat_output
from flowai.helpers.custom import format_type
from flowai.memory import astore_message, aupdate_messages, delete_message
from flowai.schema.artifact import get_artifact_type, post_process_raw
from flowai.schema.data import Data
from flowai.schema.message import ErrorMessage, Message
from flowai.schema.properties import Source
from flowai.schema.table import FieldParserType, TableOptions
from flowai.services.tracing.schema import Log
from flowai.template.field.base import UNDEFINED, Input, Output
from flowai.template.frontend_node.custom_components import ComponentFrontendNode
from flowai.utils.async_helpers import run_until_complete
from flowai.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from flowai.inputs.inputs import InputTypes
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        ...
        try:
            from flowai.io import TableInput
        except ImportError as e:
            msg = "Failed to import TableInput from flowai.io"
