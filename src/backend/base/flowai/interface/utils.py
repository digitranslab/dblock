...
from flowai.services.chat.config import ChatConfig
...
def set_langchain_cache(settings) -> None:
    ...
    from flowai.interface.importing.utils import import_class

    if cache_type := os.getenv("FLOWAI_LANGCHAIN_CACHE"):
        try:
