...
from flowai.inputs.validators import CoalesceBool
from flowai.schema.data import Data
from flowai.schema.message import Message
from flowai.services.database.models.message.model import MessageBase
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Flowai system.

    This component is used to handle text inputs in the Flowai system.
