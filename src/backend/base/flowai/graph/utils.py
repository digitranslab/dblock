...
from flowai.interface.utils import extract_input_variables_from_prompt
from flowai.schema.data import Data
from flowai.schema.message import Message
from flowai.serialization import serialize
from flowai.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from flowai.services.database.models.transactions.model import TransactionBase
from flowai.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from flowai.services.database.models.vertex_builds.model import VertexBuildBase
...
if TYPE_CHECKING:
    from flowai.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from flowai.graph.schema import InterfaceComponentTypes
