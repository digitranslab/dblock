...
from flowai.logging.logger import InterceptHandler


class FlowaiUvicornWorker(UvicornWorker):
...
class FlowaiApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "flowai.server.FlowaiUvicornWorker"
