...
from flowai.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from flowai.services.store.schema import (
...
from flowai.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.flowai.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates flowai with the store which is a Directus instance.
