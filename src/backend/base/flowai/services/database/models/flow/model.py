# Path: src/backend/flowai/services/database/models/flow/model.py
...
if TYPE_CHECKING:
    from flowai.services.database.models import TransactionTable
    from flowai.services.database.models.folder import Folder
    from flowai.services.database.models.message import MessageTable
