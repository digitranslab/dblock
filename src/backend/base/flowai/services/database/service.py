...
from flowai.services.base import Service
from flowai.services.database import models
from flowai.services.database.models.user.crud import get_user_by_username
from flowai.services.database.utils import Result, TableResults
...
class DatabaseService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        # This file is in flowai.services.database.manager.py
        # the ini is in flowai
        flowai_dir = Path(__file__).parent.parent.parent
        self.script_location = flowai_dir / "alembic"
        self.alembic_cfg_path = flowai_dir / "alembic.ini"
        ...
        if Path(alembic_log_file).is_absolute():
            ...
            self.alembic_log_path = Path(flowai_dir) / alembic_log_file
