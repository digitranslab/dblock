...
from flowai.services.schema import ServiceType
...
if TYPE_CHECKING:
    ...
    from flowai.services.cache.service import AsyncBaseCacheService, CacheService
    from flowai.services.chat.service import ChatService
    from flowai.services.database.service import DatabaseService
    from flowai.services.session.service import SessionService
    from flowai.services.settings.service import SettingsService
    from flowai.services.socket.service import SocketIOService
    from flowai.services.state.service import StateService
    from flowai.services.storage.service import StorageService
    from flowai.services.store.service import StoreService
    ...
    from flowai.services.variable.service import VariableService
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from flowai.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from flowai.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from flowai.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from flowai.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from flowai.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> SettingsService:
    ...
    """
    from flowai.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from flowai.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> CacheService | AsyncBaseCacheService:
    ...
    """
    from flowai.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from flowai.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from flowai.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from flowai.services.task.factory import TaskServiceFactory
