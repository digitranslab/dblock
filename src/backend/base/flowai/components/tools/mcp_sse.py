...
from flowai.base.mcp.util import create_tool_coroutine, create_tool_func
from flowai.components.tools.mcp_stdio import create_input_schema_from_json_schema
from flowai.custom import Component
from flowai.field_typing import Tool
from flowai.io import MessageTextInput, Output
from flowai.utils.async_helpers import timeout_context
...
class MCPSse(Component):
    ...
    description = "Connects to an MCP server over SSE and exposes it's tools as flowai tools to be used by an Agent."
