...
from flowai.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from flowai.helpers import docs_to_data
from flowai.inputs import FloatInput, NestedDictInput
...
class AstraDBVectorStoreComponent(LCVectorStoreComponent):
    ...
    documentation: str = "https://docs.datastax.com/en/flowai/astra-components.html"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    def build_vector_store(self):
        ...
        # Get Flowai version and platform information
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{flowai_prefix}flowai", __version__)],
