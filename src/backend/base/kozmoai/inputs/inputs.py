...
from kozmoai.inputs.validators import CoalesceBool
from kozmoai.schema.data import Data
from kozmoai.schema.message import Message
from kozmoai.services.database.models.message.model import MessageBase
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Kozmoai system.

    This component is used to handle text inputs in the Kozmoai system.
