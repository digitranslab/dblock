...
from kozmoai.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
from kozmoai.services.database.models.folder.model import Folder, FolderCreate, FolderRead
from kozmoai.services.database.models.user.crud import get_user_by_username
from kozmoai.services.deps import get_settings_service, get_storage_service, get_variable_service, session_scope
from kozmoai.template.field.prompt import DEFAULT_PROMPT_INTUT_TYPES
from kozmoai.utils.util import escape_json_dump
...
async def load_flows_from_directory() -> None:
    """On kozmoai startup, this loads all flows from the directory specified in the settings.
...
async def create_or_update_starter_projects(all_types_dict: dict, *, do_create: bool = True) -> None:
    ...
    async with session_scope() as session:
        ...
        for project_path, project in starter_projects:
            ...
            do_update_starter_projects = os.environ.get("KOZMOAI_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
