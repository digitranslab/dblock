...
PYPI_FLOWAI_URL = "https://pypi.org/pypi/flowai/json"
PYPI_FLOWAI_NIGHTLY_URL = "https://pypi.org/pypi/flowai-nightly/json"

PYPI_FLOWAI_BASE_URL = "https://pypi.org/pypi/flowai-base/json"
PYPI_FLOWAI_BASE_NIGHTLY_URL = "https://pypi.org/pypi/flowai-base-nightly/json"
...
def get_latest_published_version(build_type: str, *, is_nightly: bool) -> Version:
    ...
    url = ""
    if build_type == "base":
        url = PYPI_FLOWAI_BASE_NIGHTLY_URL if is_nightly else PYPI_FLOWAI_BASE_URL
    elif build_type == "main":
        url = PYPI_FLOWAI_NIGHTLY_URL if is_nightly else PYPI_FLOWAI_URL
    else:
