"""Script to update Flowai starter projects with the latest component versions."""

import asyncio
import os

import flowai.main  # noqa: F401
...
async def main():
    ...
    Copies the code from flowai/initial_setup/setup.py. Doesn't use the
