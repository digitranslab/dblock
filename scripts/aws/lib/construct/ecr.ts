...
export class EcrRepository extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ECRProps) {
    ...
    const backendPath = path.join(__dirname, "../../../../../", "flowai")
    ...
    // Backend ECR リポジトリ作成
    this.ecrBackEndRepository = new ecr.Repository(scope, 'FlowaiBackEndRepository', {
      repositoryName: 'flowai-backend-repository',
